#ifndef CLRSYNC_CORE_PALETTE_HELLWAL_MAPPINGS_HPP
#define CLRSYNC_CORE_PALETTE_HELLWAL_MAPPINGS_HPP
...
inline constexpr index_color_mapping HELLWAL_COLOR_MAPPINGS[] = {
    // General UI
    {"background", 0},
    {"foreground", 7},
    {"cursor", 15},
...
inline constexpr std::size_t HELLWAL_COLOR_MAPPINGS_COUNT =
    sizeof(HELLWAL_COLOR_MAPPINGS) / sizeof(HELLWAL_COLOR_MAPPINGS[0]);
